...
const HomeBankTransferModal: React.FC<PaymentInstructionProps> = ({
  ...
  const cashCenters: CenterDetails[] = [
    ...
    {
      name: "Vision Academy - Garden Town",
      address: "10-B, Main Boulevard, Aibak Block Garden Town, Lahore, 53200",
      // Link 2: Gulberg Direct Link (Extracted from your search query for cleaner direction)
      mapLink: "https://www.google.com/maps/dir//10-B,+Main+Boulevard,+Aibak+Block+Garden+Town,+Lahore,+53200"
    },
    {
